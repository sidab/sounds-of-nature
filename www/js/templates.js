Framework7.registerComponent('list-item', {
    template: `
        ...
        <div class="col-50 medium-50 item" data-index="{{$props.index}}" data-name="{{$props.name}}" data-image="{{$props.image}}" style="background-image: url('{{$props.image}}')">
            ...
            <div class="range-slider-out swiper-no-swiping">
